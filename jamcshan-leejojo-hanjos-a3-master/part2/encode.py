...
def encode(str, replace_table, rearrange_table):
    ...
    # rearrange table should be 1d list
    # inner "".join()
    # letters are joined w/o spaces according to rearrange table for sequences of len(table)
    # outer "".join()
    # joins the sections of chars of length len(table) together to form the sentence
