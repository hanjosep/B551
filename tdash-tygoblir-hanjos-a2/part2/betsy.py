...
# valuespots: returns all piece values + how many reachable squares there are.
def value_spots(board):
    ...
    for row in range(0,8):
        for col in range(0,8):
            ...
            if board[row][col] in white_pieces:
                ...
                totalval += len(valid_spots(board,(row,col)))/multiple
